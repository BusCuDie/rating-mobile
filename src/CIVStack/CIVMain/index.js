    ...
    <Tab.Navigator
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({color}) => <Icon name="home-outline" size={23}  color={color}/>,
        }}
      ...
      <Tab.Screen
        ...
        options={{
          tabBarLabel: 'Hỏi đáp',
          tabBarIcon: ({color}) => <Icon name="ios-chatbubble-outline" size={23}  color={color}/>,
        }}
        initialParams={{currentUser:route.params.currentUser}}
      />
      {/* <Tab.Screen
        ...
        options={{
          tabBarLabel: 'Liên hệ',
          tabBarIcon: ({color}) => <Icon name="send-outline" size={23} color={color}/>,
        }}
        initialParams={{currentUser:route.params.currentUser}}
      /> */}
      <Tab.Screen
